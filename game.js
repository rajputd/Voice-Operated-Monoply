...
module.exports = function(player_num, player_names) {
  ...
  //initialize board and properties
  ...
  this.gameBoard = [space0, space1, space2, space3, space4, space5, space6, space7,
  ...
  this.chanceCards = [chance0, chance1, chance2, chance3, chance4, chance5,
  ...
  this.chestCards = [chest0, chest1, chest2, chest3, chest4, chest5, chest6,
